...
const SoftwareInstallationPage = () => {
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/send-quote-email', {
        ...
        body: JSON.stringify({
          ...quoteForm,
          productName: 'Software Installation Service',
        }),
      });
  ...
  const services = [
    { icon: Monitor, title: 'OS Installation', description: 'Windows, Linux, and macOS installation and setup' },
    { icon: Shield, title: 'Antivirus Setup', description: 'Install and configure antivirus protection' },
    { icon: Zap, title: 'System Optimization', description: 'Speed up your system with optimization' },
    { icon: Package, title: 'Software Setup', description: 'Install and configure any software application' },
    { icon: RefreshCw, title: 'Driver Updates', description: 'Update all drivers for optimal performance' },
    { icon: FileText, title: 'Office Suite', description: 'Microsoft Office and productivity software setup' },
  ];
          ...
          <div className="flex flex-col md:flex-row items-start gap-8">
            <div className="flex-1">
              ...
              <p className="text-lg text-blue-100 leading-relaxed mb-8 max-w-2xl">
                Complete software setup, installation, and optimization services. 
                From operating systems to specialized applications, we handle it all.
              </p>
              <Button 
                size="lg"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-[#6B7280] mb-8">
                We provide professional software installation and configuration services. 
                Get your system set up correctly from the start.
              </p>
            ...
            <div className="bg-gradient-to-br from-[#1E40AF] to-[#3B82F6] rounded-2xl p-8 text-white">
              <h3 className="font-display text-2xl font-bold mb-4">Why Professional Installation?</h3>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 flex-shrink-0 mt-0.5" />
                  <span>Proper configuration for optimal performance</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 flex-shrink-0 mt-0.5" />
                  <span>Avoid compatibility issues and conflicts</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 flex-shrink-0 mt-0.5" />
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 flex-shrink-0 mt-0.5" />
                  <span>All drivers and updates installed</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 flex-shrink-0 mt-0.5" />
                  <span>Post-installation support included</span>
                </li>
              </ul>
              <Button 
                size="lg"
      ...
      <Dialog open={isQuoteDialogOpen} onOpenChange={setIsQuoteDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          ...
          <form onSubmit={handleFormSubmit} className="space-y-4 mt-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="message">What Software Do You Need?</Label>
              <Textarea
                id="message"
                name="message"
                value={quoteForm.message}
                onChange={handleFormChange}
                placeholder="List the software you need installed..."
                rows={4}
              />
            </div>
...
export default SoftwareInstallationPage;
