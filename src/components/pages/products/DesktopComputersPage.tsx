  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/send-quote-email', {
        ...
        body: JSON.stringify({
          ...quoteForm,
          productName: selectedProduct?.title || 'Desktop Computer Inquiry',
        }),
      });
        ...
        <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-lg text-blue-100 leading-relaxed mb-8 max-w-2xl">
              Discover our range of desktop computers from budget-friendly office PCs to high-end 
              gaming rigs. We also offer custom build services tailored to your exact specifications.
            </p>
          </div>
        </div>
      </section>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-xl font-bold text-[#1E40AF]">
                      {product.originalPrice ? 'Starting ' : ''}₹{product.price.toLocaleString('en-IN')}
                    </span>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-[#6B7280] mb-8 max-w-2xl mx-auto">
            We specialize in building custom PCs tailored to your exact needs. Tell us your requirements 
            and budget, and we'll create the perfect system for you.
          </p>
          <Link to="/contact">
          ...
          <form onSubmit={handleFormSubmit} className="space-y-4 mt-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={handleFormChange}
                placeholder="Any specific specs or requirements..."
                rows={4}
              />
            </div>
...
export default DesktopComputersPage;
